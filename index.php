...
<head>
  ...
  <title>UICUI | E-commerce Home</title>
		...
		<div class="row">
			<div class="col-md-4 col-xs-12 col-sm-4">
				<div class="contact-number">
					...
					<span>01(712) 283 1012 01-800-5059610</span>
				</div>
			</div>
			<div class="col-md-4 col-xs-12 col-sm-4">
				<!-- Site Logo -->
	...
	<nav class="navbar navigation">
	    <div class="container">
	      ...
	      <div id="navbar" class="navbar-collapse collapse text-center">
			...
			<!-- Shop -->
	          <li class="dropdown dropdown-slide">
	            <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="false">CONTACTO<span class="tf-ion-ios-arrow-down"></span></a>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<p class="copyright-text">Elavolado por Alan e Ivan</p>
			</div>
		</div>
	</div>
</footer>
